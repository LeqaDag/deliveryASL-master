            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  children: <Widget>[
                    _profileData(
                        "الاسم", false, TextInputType.text, nameController),
                    _profileData("العنوان", false, TextInputType.text,
                        addressnameController),
                    _profileData("رقم الهاتف", false, TextInputType.phone,
                        phoneController),
                    _profileData("البريد الالكتروني", false,
                        TextInputType.emailAddress, emailController),
                    _profileData("كلمة المرور", true, null, passwordController),
                    _editButton(),
                  ],
                ),
              ),
